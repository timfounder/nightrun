...
const translations = {
  ru: {
    ...
    'inc.title':'Что ты получаешь','inc.desc':'— С каждой регистрацией мы делаем нечто большее, чем просто ран. Часть средств идёт на благотворительность.<br/>— Ты не просто приходишь на пробежку — ты становишься частью комьюнити, которое помогает другим.',
    'inc.1.title':'Комплимент от Yurgo','inc.1.desc':'Приятный подарок от организаторов каждому участнику забега.',
  ...
  uz: {
    ...
    'inc.title':'Siz nima olasiz','inc.desc':"— Har bir ro'yxatdan o'tish — bu shunchaki yugurish emas. Mablag'ning bir qismi xayriyaga yo'naltiriladi.<br/>— Siz shunchaki yugurmaysiz — boshqalarga yordam beradigan jamoaning bir qismi bo'lasiz.",
    'inc.1.title':"Yurgo'dan sovg'a",'inc.1.desc':"Har bir ishtirokchiga tashkilotchilardan yoqimli sovg'a.",
  ...
  en: {
    ...
    'inc.title':'What you get','inc.desc':"— Every registration is more than a run. Part of the fee goes to charity.<br/>— You don't just show up for a run — you become part of a community that helps others.",
    'inc.1.title':'Gift from Yurgo','inc.1.desc':'A pleasant present from organizers for every participant.',
